...
export default function Chatbot({ isOpen, onToggle }: Props) {
  ...
  if (!isInitialized) {
    return (
      <div className="fixed bottom-6 right-6 w-96 h-32 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 flex items-center justify-center z-50">
  ...
  return (
    <div className="fixed bottom-6 right-6 w-96 h-[32rem] bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 flex flex-col z-50 overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
      {/* Header */}
