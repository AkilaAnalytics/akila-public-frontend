...
export default function KeyPoints({ title, subTitle, keyPoints }: Props) {
  return (
    <div className="flex w-full flex-col space-y-8 p-5 md:px-32">
      ...
      <div className="flex w-full flex-col justify-center gap-8 rounded-md bg-secondaryBackground p-8 md:grid md:grid-cols-2 md:gap-24 md:p-12 md:px-16">
